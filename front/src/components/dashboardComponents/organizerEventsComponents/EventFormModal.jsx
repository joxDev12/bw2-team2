            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="mb-3">
                ...
                <div className="d-flex align-items-center gap-2 flex-wrap mt-2">
                  ...
                  />
                  <label htmlFor={fileInputId} className="btn btn-outline-primary rounded-3 mb-0">
                    Scegli la foto
                  </label>
                  <span className="text-muted small">{nomeImmagine || "nessuna foto selezionata"}</span>
                </div>
              </div>
              ...
              <div className="row g-2">
                <div className="col-md-6">
                  ...
                  <input type="text" className="form-control" name="title" value={form.title} onChange={onChange} required maxLength="500" />
                </div>
                <div className="col-md-6">
                ...
                <div className="col-md-6">
                  ...
                  <select className="form-select" name="location" value={form.location} onChange={onChange} required>
                ...
                <div className="col-md-6">
                  ...
                  <input type="text" className="form-control" name="indirizzo" value={form.indirizzo} onChange={onChange} maxLength="500" />
                </div>
                <div className="col-md-3">
                  <label className="form-label fw-semibold">Prezzo</label>
                  <input type="number" className="form-control" name="price" value={form.price} onChange={onChange} min="0" step="0.01" />
                </div>
                <div className="col-md-3">
                  <label className="form-label fw-semibold">Posti Massimi</label>
                  <input type="number" className="form-control" name="max_seats" value={form.max_seats} onChange={onChange} required min={minPosti} />
                </div>
                <div className="col-12">
                  <label className="form-label fw-semibold">Descrizione</label>
                  <textarea className="form-control" name="description" rows="2" value={form.description} onChange={onChange}></textarea>
                </div>
              </div>

              <div className="d-flex justify-content-end gap-2 mt-3 pt-3 border-top">
                <button type="button" className="btn btn-light rounded-pill px-4" onClick={onClose}>Annulla</button>
                <button type="submit" className="btn btn-primary rounded-pill px-4" disabled={caricamento}>
